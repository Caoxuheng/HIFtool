...
class Spa_Downs(nn.Module):
    ...
    def __init__(self, n_planes, factor, kernel_type, phase=0, kernel_width=None, support=None, sigma=None, preserve_size=False):
        ...
        elif kernel_type == 1:  #'lanczos3':
            support = 3
            kernel_width = 6 * factor + 1
            kernel_type_ = 'lanczos'

        elif kernel_type == 2:  #'gauss12':
            kernel_width = kernel_width
            sigma = sigma
            kernel_type_ = 'gauss'

        elif kernel_type == 3:  #'gauss1sq2':
            kernel_width = 9
            sigma = 1./np.sqrt(2)
            kernel_type_ = 'gauss'
        ...
        downsampler = nn.Conv2d(n_planes, n_planes, kernel_size=kernel_size, stride=factor, padding=0)
    ...
    def Return_Kernel(self):
        return self.kernel, self.kernel_size
